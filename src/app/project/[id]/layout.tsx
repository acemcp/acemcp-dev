  ...
  return (
    <div className="flex min-h-screen bg-slate-950 text-slate-100">
      ...
      >
        ...
        {!isSidebarCollapsed && (
          <div className="mt-auto mx-4 mb-7 rounded-2xl border border-slate-800/60 bg-gradient-to-br from-slate-900/80 to-slate-900/60 p-4 text-sm text-slate-300 backdrop-blur">
