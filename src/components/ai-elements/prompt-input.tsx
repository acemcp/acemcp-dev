...
export const PromptInputTextarea = forwardRef(function PromptInputTextarea(
  ...
  // If a provider is present, use its controlled value; otherwise allow
  // parent to pass a controlled `value` prop directly (via props).
  const controlledProps = controller
    ...
    : {
        onChange,
        // pass-through value if provided by parent
